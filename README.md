# 永恆數位榮譽證書 - NFT 證書發行系統
專案說明影片：https://youtu.be/Xez2AZBW820  

## 重要提示

> **OpenSea 測試網更新**: OpenSea 已於 2024 年停止支援測試網。  
> **查看您的 NFT**: 請使用本專案的前端應用、MetaMask 或 Etherscan 查看測試網 NFT。  
> **詳細說明**: 請參閱 `NFT_VIEWING_ALTERNATIVES.md` 了解所有查看方式。
...
- `SEPOLIA_PRIVATE_KEY`: MetaMask 私鑰 (僅測試網用)
...
# 4. 查看您的 NFT
# 前端應用: npm run frontend
# Etherscan: https://sepolia.etherscan.io/address/您的合約地址
# 注意: OpenSea 已停止支援測試網
```
