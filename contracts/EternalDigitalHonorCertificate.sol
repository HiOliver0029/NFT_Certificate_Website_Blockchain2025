...
contract EternalDigitalHonorCertificate is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Eternal Digital Honor Certificate", "EDHC") Ownable(msg.sender) {
        ...
        // 初始化證書圖片 URI (這裡使用範例 IPFS 連結)
        certificateImages[CertificateType.BLOCKCHAIN_PIONEER] = "https://ipfs.io/ipfs/QmYourImageHash1";
        certificateImages[CertificateType.ETERNAL_FRIENDSHIP] = "https://ipfs.io/ipfs/QmYourImageHash2";
        certificateImages[CertificateType.WEB3_CITIZEN] = "https://ipfs.io/ipfs/QmYourImageHash3";
        certificateImages[CertificateType.COURSE_COMPLETION] = "https://ipfs.io/ipfs/QmYourImageHash4";
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        tokenId.toString(),
                        '", "description": "',
                        unicode"永恆數位榮譽證書 - 基於區塊鏈的不可竄改數位證書，證明持有者的成就與榮譽。此證書具有唯一性、永久性，並可在區塊鏈上公開驗證。",
                        '", "image": "',
                        cert.imageURI,
                        '", "attributes": [',
